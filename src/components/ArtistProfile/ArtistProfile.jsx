...
const popularTracks = [
  {
    ...
    title: "Agency five.",
    year: "2024",
    description: "Sell real still six.",
  },
  {
    id: 2,
    title: "Huge.",
    year: "2016",
    description: "Though successful from.",
  },
...
function ArtistProfile() {
  let [artistProfile, setArtistProfile] = useState(null);
  useEffect(() => {
    axios
      .get("/api/library/artists?artistId=2")
      .then((response) => {
  ...
  const sampleImages = [
    "../../../public/images/artwork/don-toliver/Don-Toliver-Wireless-Festival-2024-1024x437-1.jpg",
    "../../../public/images/artwork/don-toliver/Don-Toliver-Wireless-Festival-2024-1024x437-1.jpg",
    "../../../public/images/artwork/don-toliver/Don-Toliver-Wireless-Festival-2024-1024x437-1.jpg",
    "../../../public/images/artwork/don-toliver/Don-Toliver-Wireless-Festival-2024-1024x437-1.jpg",
    "../../../public/images/artwork/don-toliver/Don-Toliver-Wireless-Festival-2024-1024x437-1.jpg",
    ...
    <div className="w-full h-[calc(100%-3.5rem)] overflow-y-scroll">
      <div className="w-full p-0 pt-2 flex flex-col text-gray-100">
        ...
        <div className="w-full h-64 mb-6 relative mx-0">
          <img
            src={artistProfile?.artist[0].image}
            alt="Artist Banner"
          ...
          <div className="absolute w-full h-full inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent">
            <div className="w-full h-full relative">
              <h1 className="absolute font-bold text-3xl text-white bottom-6 left-6 drop-shadow-lg">
                {artistProfile
                  ? artistProfile.artist[0].artistName
                  : "Loading..."}
              </h1>
            </div>
          </div>
          ...
          <div className="absolute right-4 top-1/2 -translate-y-1/2 flex flex-row gap-2">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="w-12 h-12 rounded-sm overflow-hidden opacity-80 hover:opacity-100 transition-opacity"
              >
                <img
          ...
          <div className="flex flex-row gap-4 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-transparent">
            {discoveryTracks.map((track, index) => (
              <DiscoveryCard
                ...
                track={track}
                image={
                  sampleImages[index % sampleImages.length] || "/images8/1.jpg"
                }
              />
            ))}
          </div>
